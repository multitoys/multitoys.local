...
//                }                
        ...
        protected function transform_auxpage_conc($name, $text)
        {
            ...
            if (!$div_cat) {
                $order = 'date_added DESC, category, code DESC';
            }
...
//                $p_count = 10;
            ...
            ';
                ...
                $query = 'SELECT productID FROM SC_category_product WHERE categoryID=66666';
                $res = mysql_query($query) or die(mysql_error().$query);
                $new = array();
...
//                    $price = ($buy_enabled)?show_price($price_without_unit):'';
                ...
                $newitems .= "<div class=shapka><div class='simple-pagination compact-theme'>$out</div></div>";
                $newitems .= '
                                </div>';
