...
$(document).ready(function () {
    ...
    function addLoaderSmoke() {
        var scrollPaine = $(".scroll-pane1");
        $("#center").addClass("smoke");
        scrollPaine.addClass("loader");
        scrollPaine.baron().dispose();
    }

    function removeLoaderSmoke() {
        var scrollPaine = $(".scroll-pane1");
        $("#center").removeClass("smoke");
