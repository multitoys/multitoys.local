...
//    $res = mysql_query($query) or die(mysql_error()."<br>$query");
    ...
    $query = 'INSERT INTO Search_products (categoryID, code_1c, product_code, name_ru, Price, enabled, brand)
              SELECT  categoryID, code_1c, product_code, name_ru, Price, enabled, brand FROM SC_products  WHERE in_stock = 100';
    $res = mysql_query($query) or die(mysql_error() . "<br>$query");
